...
import { forBrandsConfig } from '../config';
...
export function ForBrands({setIsModalOpen}: ForBrandsProps) {
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:pl-8">
            <ul ref={featuresRef} className="space-y-4">
              {forBrandsConfig.features.map((feature, index) => (
                <li
                  key={index}
